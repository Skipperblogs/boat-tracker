...
class BOAT_TRACKING_Plugin_Option
{
    ...
    function widget ($name, $value) 
    {
        ...
        <textarea 
            id="<?php echo esc_html($name); ?>"
            class="full-width" 
            name="<?php echo esc_html($name); ?>"><?php echo esc_html(htmlspecialchars($value)); ?></textarea>
        ...
        default:
            ?>
        <div>No option type chosen for <?php echo esc_html($name); ?> with value <?php echo esc_html(htmlspecialchars($value)); ?></div>
            <?php
            break;
        }
    }
