...
waitForJquery(async function () {
    ...
    $( "#map" ).attr('data-zoom',data.zoom);
    $( "#map" ).attr('data-provider-max-zoom',data.max_zoom);
    $( "#map" ).attr('data-center-on',data.center_on);
    $( "#map" ).attr('data-lat',data.lat);
    $( "#map" ).attr('data-lng',data.lng);
    $( "#map" ).attr('data-controls-position','top-left');
    $( "#map" ).attr('data-provider-url',data.provider_url);
    $( "#map" ).attr('data-boat-icon',data.boat_icon);
